...
costFunction =  @(t)(nnCostFunction(t, X_train, y_class_train, lambda));
...
% plot learning Curve, return error values to manually set axis
[error_train, error_val, loop] = learningCurve(X_train, y_class_train, X_cv, y_class_cv, [init_theta1(:); init_theta2(:)], lambda);
